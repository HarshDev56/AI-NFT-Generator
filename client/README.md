# AI-NFT-Generator
![Capture4](https://github.com/HarshDev56/AI-NFT-Generator/assets/87370920/3955c3b8-d9bd-4149-bb53-007658441744)
Built with ❤️ using: 
* ReactJS
* Ethers
# Getting Started
...
```
git clone https://github.com/HarshDev56/AI-NFT-Generator.git
cd AI-NFT-Generator
cd client
yarn
```
